     ...
     SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
        http.csrf(AbstractHttpConfigurer::disable)
                .authorizeHttpRequests(auth -> auth
                        ...
                        .requestMatchers("/doctor/all/specialization").permitAll()
                        .requestMatchers("/doctor/type").permitAll()
                        .requestMatchers("/inpatient/add").hasAnyRole("PATIENT", "ADMIN","EXECUTIVE")
                        ...
                        .requestMatchers("/addadmission/{patientid}/{issueName}/{roomtype}").hasAnyRole("PATIENT","ADMIN","EXECUTIVE")
                        ...
                        .requestMatchers("/patient/history/add/{pid}").hasAnyRole("PATIENT", "ADMIN","EXECUTIVE")
                        .requestMatchers("/executive/add").permitAll()
